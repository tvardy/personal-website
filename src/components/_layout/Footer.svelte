...
<footer class="site-footer">
  <div class="wrapper">
    <p>
      ...
      theme
      <small>
        This website <strong>is not</strong> using any cookies nor trying to track its
        users in any unlawful way. <br />
        <strong>Read freely!</strong>
      </small>
      Subscribe via <a href="feed.xml" target="_blank">RSS</a>
      <br />
    </p>
  </div>
</footer>
